...
**定位要点**（演进：Logto 专用用户中心 → 多租户 IAM 用户管理系统 → **SSO 用户管理平台**，总纲见 [SSO平台功能目标与实现方案.md](SSO平台功能目标与实现方案.md)）：
...
├── README.md             # 项目说明
├── SSO平台功能目标与实现方案.md  # 定位与功能/实现总纲（当前权威）
├── 总体技术方案.md        # 技术架构文档
├── 功能模块集成与实现规划.md    # 模块级集成/实现拆分
├── 项目文件结构.md        # 文件结构说明
└── AI实现步骤方案.md      # 开发实施计划
```
...
- [SSO平台功能目标与实现方案](SSO平台功能目标与实现方案.md) - **定位与功能/实现总纲（当前权威）**
- [总体技术方案](总体技术方案.md) - 系统架构设计
- [功能模块集成与实现规划](功能模块集成与实现规划.md) - 模块级集成/实现拆分 + Logto 调研结论
